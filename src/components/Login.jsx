...
const Login = () => {
    ...
    return (
        <div style={{ backgroundColor: "#202529" }} className="flex items-center justify-center min-h-screen">
            <div className="w-full max-w-4xl mx-auto shadow-lg bg-white rounded-lg overflow-hidden m-8">
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="w-full p-8 py-12 md:w-1/2">
                        <h1 className="text-5xl font-extrabold text-center text-red-600 mb-9">LogIn</h1>
                        ...
                        <form onSubmit={submitForm}>
                            ...
                            <div className="mb-3 relative">
                                ...
                                <a href="index.html" className="text-red-600 block text-right mb-4 ">Forget password?</a>
                            </div>
                            <button
                                type="submit"
                        ...
                        <button className="flex items-center justify-center w-full border border-gray-300 rounded p-3 mb-3 hover:bg-gray-100">
                            ...
                            <span className="flex-grow text-center text-xl text-gray-700">Login with Google</span>
                        </button>

                        <button className="flex items-center justify-center w-full border border-gray-300 rounded p-3 hover:bg-gray-100">
                            <img src={facebookIcon} alt="Facebook Icon" className="w-5 mr-3" />
                            <span className="flex-grow text-center text-xl text-gray-700">Login with Facebook</span>
                        </button>
